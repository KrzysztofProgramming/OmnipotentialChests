package wg.omnipotentialchests.chests.omnipotentialchests.configs.resourcesConfigGenerator;
...
public class ConfigGenerator {
    ...
    public OmnipotentialChests pluginInstance;
    private File configsFolder;

    public void init() {
        this.pluginInstance = OmnipotentialChests.getInstance();
